...
const createElement = ({title, price}, prodId, deleteProductFn) => {
...
export const renderProducts = (products, deleteProductFn) => {
...
export const updateProducts = (product, prodId, deleteProductFn, isAdding) => {
  if (isAdding) {
